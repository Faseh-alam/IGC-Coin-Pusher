...
public class CoinSpawner : MonoBehaviour {
	...
	// Spawn the coin on the horizontal plane instead of vertical
	...
	public void spawnCoin(Vector3 position)
	{
		...
		if( findItem == findCommon )
		{
			if( common.Length != 0 )
			{
				...
				GameObject.Instantiate(common[Random.Range (0, common.Length)], spawnLocation, coinRot);
			}
		}
		...
		if( findItem == findRare )
		{
			if( rare.Length != 0 )
			{
				...
				GameObject.Instantiate(rare[Random.Range (0, rare.Length)], spawnLocation, coinRot);
			}
		}
		...
		if( findItem == findEpic )
		{
			if( epic.Length != 0 )
			{
				...
				GameObject.Instantiate(epic[Random.Range (0, epic.Length)], spawnLocation, coinRot);
			}
		}
		...
		if( findItem != findCommon && findItem != findRare && findItem != findEpic )
		{
			...
			GameObject.Instantiate(coins[Random.Range (0, coins.Length)], spawnLocation, coinRot);
	    }
	}
