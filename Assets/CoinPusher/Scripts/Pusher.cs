...
public class Pusher : MonoBehaviour {
	...
	void Update()
	{
		...
		{
			// Move the push bar
			GetComponent<Rigidbody>().MovePosition(Vector3.Lerp (originalPosition, new Vector3(destination.position.x, originalPosition.y, originalPosition.z), Mathf.PingPong(timeTracker * moveSpeed, 1.0f)));
